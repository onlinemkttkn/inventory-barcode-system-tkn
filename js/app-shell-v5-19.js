(() => {
  ...
  const ROUTES = Object.freeze([
    ...
    { key:'scan', group:'งานหลัก', label:'ตรวจสต็อก / เบิกกล่อง', short:'สต็อก/เบิก', href:'./mobile-stock-check.html', icon:'scan', any:['inventory.view','inventory.count','inventory.issue','product.manage','pos.use'], pages:['mobile-stock-check.html','scanner.html'] },
  ...
  const PAGE_NAMES = Object.freeze({
    ...
    'mobile-stock-check.html':'ตรวจสต็อกและเบิกกล่อง', 'sort-pack-qr.html':'แยกสินค้าและปิดกล่อง', 'scanner.html':'สแกน', 'box-qr-stock.html':'Box QR',
  ...
  function registerServiceWorker() {
    ...
    window.addEventListener('load', () => {
      navigator.serviceWorker.register('./service-worker-v5.25.12.js', { scope:'./' })

...
async function init(){
 try{if(window.TKNAuthGuard?.requireAccess)await window.TKNAuthGuard.requireAccess({permission:'inventory.receive'});}catch(e){msg(e.message||'ไม่มีสิทธิ์ใช้งาน','bad');return}

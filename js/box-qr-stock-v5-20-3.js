(() => {
  ...
  function bindEvents() {
    ...
    $("trackingCameraBtn").onclick = () => { void openCamera("tracking"); };
    $("receiveProductCameraBtn").onclick = () => { void openCamera("receive-product"); };
    $("boxProductCameraBtn").onclick = () => { void openCamera("box-product"); };
    $("checkCameraBtn").onclick = () => { void openCamera("check"); };

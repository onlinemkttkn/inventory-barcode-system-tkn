(() => {
  ...
  async function closeBox() {
    ...
    audit("BOX_CLOSE", S.box.id, `ยืนยันจากการสแกน ${S.boxItems.length} SKU · ${total} ชิ้น`);
    save();
  ...
  function renderFinalSummary() {
    ...
    $("finalBoxSummary").innerHTML = `
      <article><span>รหัสกล่อง</span><b>${esc(S.box.id)}</b></article>

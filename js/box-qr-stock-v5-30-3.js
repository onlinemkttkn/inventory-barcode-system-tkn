(() => {
  ...
  function applyBoxPrintSettings(persist = true, redraw = true) {
    ...
    style.textContent=printMode==='ROLL'?`@page{size:${profile.width}mm ${profile.height}mm;margin:${Number(settings.pageMargin||0)}mm}`:`@page{size:A4 portrait;margin:${Number(settings.pageMargin||0)}mm}`;

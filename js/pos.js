...
function updateTotals() {
  ...
  const net = netValue();
  const received = Math.max(toNumber(E.received.value), 0);
...
E.discount.addEventListener("input", updateTotals);
E.received.addEventListener("input", updateTotals);
E.payment.addEventListener("change", updateTotals);
